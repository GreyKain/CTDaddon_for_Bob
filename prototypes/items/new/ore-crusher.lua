    ...
    },
    {
        ...
        graphics_set = {
            animation = {
                layers = {
                    {
                        filename = "__CTDaddon_for_Bob__/graphics/entity/Angel/ore-crusher/hr-ore-crusher-base.png",
                        priority = "extra-high",
                        width = 189,
                        height = 214,
                        frame_count = 16,
                    ...
                    {
                        filename = "__CTDaddon_for_Bob__/graphics/entity/Angel/ore-crusher/hr-ore-crusher-mask.png",
                        priority = "extra-high",
                        width = 189,
                        height = 214,
                        repeat_count = 16,
                    ...
                    {
                        filename = "__CTDaddon_for_Bob__/graphics/entity/Angel/ore-crusher/hr-ore-crusher-highlights.png",
                        priority = "extra-high",
                        width = 189,
                        height = 214,
                        repeat_count = 16,
                    ...
                    {
                        filename = "__CTDaddon_for_Bob__/graphics/entity/Angel/ore-crusher/hr-ore-crusher-shadow.png",
                        priority = "extra-high",
                        width = 282,
                        height = 140,
                        repeat_count = 16,
        ...
        working_sound = {
            sound = { filename = "__CTDaddon_for_Bob__/prototypes/sound/Angel/ore-crusher.ogg", volume = 0.6 },
...
if tech["sand-processing"] then
    add_tech_unlock("CTD-burner-ore-crusher", "sand-processing")
end
